...
// Config aggregates runtime configuration for the IoT service.
type Config struct {
	App       AppConfig
	HTTP      HTTPConfig
...
type AppConfig struct {
	Name    string `envconfig:"APP_NAME" default:"iot-service"`
...
type PostgresConfig struct {
	URL             string        `envconfig:"POSTGRES_URL" default:"postgres://postgres:postgres@localhost:5432/iot?sslmode=disable"`
...
type EventsConfig struct {
	...
	StreamName    string `envconfig:"NATS_STREAM" default:"iot"`
	DeliverGroup  string `envconfig:"NATS_DELIVER_GROUP" default:"iot-workers"`
	DeadLetterJet string `envconfig:"NATS_DLQ_STREAM" default:"iot-dlq"`
}
