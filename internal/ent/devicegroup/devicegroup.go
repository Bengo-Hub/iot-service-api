...
const (
	...
	MembersTable = "device_group_members"
	// MembersInverseTable is the table name for the DeviceGroupMember entity.
	// It exists in this package in order to avoid circular dependency with the "devicegroupmember" package.
	MembersInverseTable = "device_group_members"
	// MembersColumn is the table column denoting the members relation/edge.
	MembersColumn = "device_group_id"
)
